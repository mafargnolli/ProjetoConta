...
Sempre que a validação de uma requisição falhar, responda com código de erro e mensagem adequada à situação.
...
A lista abaixo é para consulta, não significa que todos os status codes precisam necessariamente ser utilizados.
